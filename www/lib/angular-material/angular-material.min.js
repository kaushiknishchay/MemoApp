  ...
  !function () {
    ...
    function o(o, i, a, d, c, s, l) {
      ...
      var u = s.startSymbol(), h = s.endSymbol(), p = "{{" === u && "}}" === h, f = {
        ...
        clientRect: function (e, t, n) {
          ...
          var r = o.getBoundingClientRect(), i = n ? t.getBoundingClientRect() : {left: 0, top: 0, width: 0, height: 0};
    ...
    function o(n, o, r) {
      ...
      return h.isHijackingClicks && h.handler("click", {
        ...
        options: {minDistance: 6, horizontal: !0, cancelMultiplier: 1.5}, onStart: function (e) {
    ...
    function e() {
      function e(e) {
        ...
        function r(t, n) {
          ...
          return c.presets[t] = {methods: n.methods.concat(a), optionsFactory: n.options, argOption: n.argOption}, s
        }
      ...
      function o(e, o, r, i, a, d, c, s, l, m, u) {
        return function () {
          function u(e) {
            e = e || {};
            var t = new g(e || {}), n = !e.skipHide && v.length ? b.hide() : o.when(!0);
            return n["finally"](function () {
              v.push(t), t.show()["catch"](function (e) {
                return e
              })
            }), t.deferred.promise
          }
          ...
          function h(e, t) {
            ...
            if (!v.length)return o.when(e);
            if (t = t || {}, t.closeAll) {
              var i = o.all(v.reverse().map(r));
              return v = [], i
            }
            if (t.closeTo !== n)return o.all(v.splice(t.closeTo).map(r));
            var a = v.pop();
            return r(a)
          }
          ...
          function g(u) {
            ...
            function $(e, n, r) {
              ...
              return o(function (t, d) {
                try {
                  i(n.scope, e, n), o.when(n.onShow(n.scope, e, n, r)).then(function () {
                    a(n.scope, e, n), M(), t(e)
                  }, d)
                } catch (c) {
                  d(c.message)
    ...
    !function () {
      ...
      function n(e) {
        function n(t, n, o) {
          var i = r(n, e, o), a = o.$observe(o.$normalize(e), i);
          i(s(e, o, "")), t.$on("$destroy", function () {
            a()
          }), E.removeAttributes && n.removeAttr(e)
        }

        return ["$mdUtil", "$interpolate", function (o, r) {
          return m = o, u = r, {
            restrict: "A", compile: function (o, r) {
              var i;
              return E.enabled && (a(e, s(e, r, ""), d(o, e, r)), i = n), i || t.noop
            }
          }
        }]
      }
      ...
      function o(e) {
        function n(t, n) {
          n.addClass(e), E.removeAttributes && n.removeAttr(e)
        }

        return ["$interpolate", function (o) {
          return u = o, {
            restrict: "A", compile: function (o, r) {
              var i;
              return E.enabled && (a(e, s(e, r, ""), d(o, e, r)), n(null, o), i = n), i || t.noop
            }
          }
        }]
      }
      ...
      function r(e, n) {
        ...
        return function (r) {
          var i = a(n, r || "");
          t.isDefined(i) && (e.removeClass(o), o = i ? n + "-" + i.replace(p, "-") : n, e.addClass(o))
        }
      }
      ...
      function d(e, t, n) {
        return function (o) {
          c(o) || (e.attr(t, o), n[n.$normalize(t)] = o)
        }
      }

      function c(e) {
        return (e || "").indexOf(u.startSymbol()) > -1
      }

      function s(e, t, n) {
        var o = t.$normalize(e);
        return t[o] ? t[o].replace(p, "-") : n || null
      }

      function l(e, t, n) {
        e = n && e ? e.replace(p, n) : e;
        var o = !1;
        return e && t.forEach(function (t) {
          t = n ? t.replace(p, n) : t, o = o || t === e
        }), o
      }

      var m, u, h = /(-gt)?-(sm|md|lg)/g, p = /\s+/g, f = ["grow", "initial", "auto", "none"], g = ["row", "column"], b = ["start start", "start center", "start end", "center", "center center", "center start", "center end", "end", "end center", "end start", "end end", "space-around", "space-around center", "space-around start", "space-around end", "space-between", "space-between center", "space-between start", "space-between end"], E = {
        enabled: !0,
        removeAttributes: !0,
        breakpoints: []
      };
    ...
    function o(e) {
      function n(n, o, i) {
        return o.controller("mdNoInk") ? t.noop : e.instantiate(r, {
          $scope: n, $element: o, rippleOptions: i
        })
      }
    ...
    t.module("material.core").factory("$mdInkRipple", o).directive("mdInkRipple", n).directive("mdNoInk", i).directive("mdNoBar", i).directive("mdNoStretch", i);
    var a = 450;
    n.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], o.$inject = ["$injector"], r.$inject = ["$scope", "$element", "rippleOptions", "$window", "$timeout", "$mdUtil"], r.prototype.getColor = function () {
      function e() {
      ...
      if (this.isRippleAllowed()) {
        var i = this, d = t.element('<div class="md-ripple"></div>'), c = this.$element.prop("clientWidth"), s = this.$element.prop("clientHeight"), l = 2 * Math.max(Math.abs(c - e), e), m = 2 * Math.max(Math.abs(s - n), n), u = r(this.options.fitRipple, l, m);
        d.css({
          left: e + "px",
          top: n + "px",
          background: "black",
        ...
        }, .35 * a, !1), this.options.dimBackground && this.container.css({backgroundColor: this.background}), this.container.append(d), this.ripples.push(d), d.addClass("md-ripple-placed"), this.$mdUtil.nextTick(function () {
        ...
        return i.inherit = function (n, i) {
          ...
          if ((v || t.isDefined(c)) && "false" != c) {
            var s = e.$watch(function () {
              return d && d.$mdTheme || ("default" == E ? "" : E)
            }, a);
            n.on("$destroy", s)
          } else {
            var l = d && d.$mdTheme || ("default" == E ? "" : E);
            a(l)
          }
    ...
    function i(e, n, o) {
      ...
      return o = o.replace(m, function (t, n, o, r, i) {
        ...
        "default" !== n && (i = i.replace(a, ".md-" + e.name + "-theme.md-" + n)), "default" == e.name && (i = i.replace(/((\w|\.|-)+)\.md-default-theme((\.|\w|-|:|\(|\)|\[|\]|"|'|=)*)/g, "$&, $1$3")), r.push(i)
      }), r
    }
    ...
    function e(e, n, o, r, i) {
      ...
      return a = {
        translate3d: function (e, t, n, o) {
          function r(n) {
            return i(e, {to: n || t, addClass: o.transitionOutClass, removeClass: o.transitionInClass}).start()
          }
    ...
    function n(e) {
      function n(e, n, i, a, d, c, s) {
        function l(o, r, s, l) {
          r = i.extractElementByName(r, "md-bottom-sheet"), h = i.createBackdrop(o, "md-bottom-sheet-backdrop md-opaque"), s.clickOutsideToClose && h.on("click", function () {
        ...
        function m(t, n, o) {
          var r = o.bottomSheet;
          return e.leave(h), e.leave(r.element).then(function () {
    ...
    function n(e) {
      function n(e, t) {
        return {
          ...
          }, controllerAs: "dialog", bindToController: !0, theme: t.defaultTheme()
        }
      }
      ...
      function o(e, n, o, r, i, a, d, c) {
        ...
        function u(n, i) {
          ...
          if (i.escapeToClose) {
            ...
            n.on("keydown", u), m.on("keydown", u), a.on("resize", c), s.push(function () {
              n.off("keydown", u), m.off("keydown", u), a.off("resize", c)
            })
          }
          if (i.clickOutsideToClose) {
            var h, m = n, p = function (e) {
              h = e.target
            }, f = function (e) {
              h === m[0] && e.target === m[0] && (e.stopPropagation(), e.preventDefault(), l())
            };
            m.on("mousedown", p), m.on("mouseup", f), s.push(function () {
              m.off("mousedown", p), m.off("mouseup", f)
            })
          }
      ...
      return n.$inject = ["$mdDialog", "$mdTheming"], o.$inject = ["$mdDialog", "$mdAria", "$mdUtil", "$mdConstant", "$animate", "$document", "$window", "$rootElement"], e("$mdDialog").setDefaults({
        ...
        options: n
      }).addPreset("confirm", {methods: ["title", "content", "ariaLabel", "ok", "cancel", "theme", "css"], options: n})
    }
      ...
      function n(n, o, r, i, a) {
        ...
        function l(e) {
          ...
          do o = e.map(function (e) {
            return e.replace("?", "")
          }), n = t.equals(I, o), n || (e = m(e), r = e.length >= I.length && e.length !== o.length); while (10 > i && !n && r);
          return n
        }
        ...
        function u(e) {
          return I.push(e.type), l(["mousedown", "focusout?", "focusin?", "mouseup", "click"]) ? (N(e), void s()) : l(["touchstart?", "touchend?", "click"]) ? (N(e), void s()) : l(["focusin"]) ? (S.open(), void s()) : l(["focusout"]) ? (S.close(), void s()) : void h()
        }
    ...
    !function () {
      ...
      function r() {
        function n(n) {
          var r = n[0], i = n.controller("mdFabSpeedDial"), a = r.querySelectorAll(".md-fab-action-item"), d = r.querySelector(".md-css-variables"), c = parseInt(e.getComputedStyle(d).zIndex);
          t.forEach(a, function (e, t) {
            var n = e.style, r = t * o;
            n.opacity = i.isOpen ? 1 : 0, n.transform = n.webkitTransform = i.isOpen ? "scale(1)" : "scale(0)", n.transitionDelay = (i.isOpen ? r : a.length - r) + "ms", n.zIndex = a.length - t + c
          })
        }
        ...
        function n(n, o, r) {
          if (o) {
            ...
            if (c && d) {
              ...
              2 * (h / c.offsetWidth));
              d.style.backgroundColor = u, d.style.borderRadius = h + "px", a.isOpen ? (s.style.pointerEvents = "initial", d.style.width = c.offsetWidth + "px", d.style.height = c.offsetHeight + "px", d.style.transform = "scale(" + p + ")", d.style.transitionDelay = "0ms", l && (l.style.transitionDelay = ".3s"), t.forEach(m, function (e, t) {
    ...
    function e(e, o, r, i) {
      function a(n, a, d, c) {
        ...
        function p(e, t, n, o, r, i, a) {
          var d = 1 / n * 100, c = (n - 1) / n, s = x({share: d, gutterShare: c, gutter: r}), l = {
            left: N({
              unit: s,
              offset: e.col,
              gutter: r
            }), width: _({unit: s, span: t.col, gutter: r}), paddingTop: "", marginTop: "", top: "", height: ""
          };
          switch (i) {
            case"fixed":
              l.top = N({unit: a, offset: e.row, gutter: r}), l.height = _({unit: a, span: t.row, gutter: r});
              break;
            case"ratio":
              var m = d / a, u = x({share: m, gutterShare: c, gutter: r});
              l.paddingTop = _({unit: u, span: t.row, gutter: r}), l.marginTop = N({unit: u, offset: e.row, gutter: r});
              break;
            case"fit":
              var h = (o - 1) / o, m = 1 / o * 100, u = x({share: m, gutterShare: h, gutter: r});
              l.top = N({unit: u, offset: e.row, gutter: r}), l.height = _({unit: u, span: t.row, gutter: r})
          }
          return l
        }
      ...
      function r(r, i, a, d) {
        ...
        function l() {
          ...
          if (!t.isDefined(i.attr("md-no-autogrow"))) {
            ...
            if (h ? (h.$formatters.push(o), h.$viewChangeListeners.push(o)) : f(), i.on("keydown input", f), isNaN(u) && (i.attr("rows", "1"), i.on("scroll", c)), t.element(n).on("resize", f), r.$on("$destroy", function () {
    ...
    function r(e) {
      function n(n, o, r, i) {
        function a(e) {
          return l.text(String(o.val() || e || "").length + "/" + d), e
        }
        ...
        h ? t.element(h).prepend(l) : m.after(l), c.$formatters.push(a), c.$viewChangeListeners.push(a), o.on("input keydown keyup", function () {
          a()
    ...
    function e(e, o, r, i, a, d) {
      function c(c, s) {
        ...
        return p = o.supplant(p, [h, c.html()]), c.empty().append(l), s.tabindex = s.tabindex || "0", function (c, s, l, m) {
          ...
          var I = {role: "combobox", "aria-expanded": "false"};
          s[0].hasAttribute("id") || (I.id = "select_" + o.nextUid()), s.attr(I), c.$on("$destroy", function () {
    ...
    function a(e) {
      function o(e, o, c, s, l, m, u, h) {
        ...
        function v(e, n, o) {
          ...
          var S, D, I, O;
          v ? (S = E.left, D = E.top + E.height, I = "50% 0", D + x.height > M.bottom && (D = E.top - x.height, I = "50% 100%")) : (S = E.left + N.left - N.paddingLeft + 2, D = Math.floor(E.top + E.height / 2 - N.height / 2 - N.top + g.scrollTop) + 2, I = N.left + E.width / 2 + "px " + (N.top + N.height / 2 - g.scrollTop) + "px 0px", O = E.width + N.paddingLeft + N.paddingRight);
          ...
          return {
            ...
            dropDown: {
              element: t.element(f),
              styles: {transformOrigin: I, transform: o.alreadyOpen ? "" : c.supplant("scale({0},{1})", [L, P])}
            }
          }
        }
    ...
    function r(e, o, r, i, a, d, c, s, l, m) {
      ...
      return {
        restrict: "E", scope: {isOpen: "=?mdIsOpen"}, controller: "$mdSidenavController", compile: function (e) {
    ...
    function e(e, n, o, r, i, a, d, c, s) {
      ...
      function m(o, l, m, u) {
        ...
        function k(e) {
          var t = 100 * e + "%";
          q.css("width", t), z.css("left", t), l.toggleClass("md-min", 0 === e), l.toggleClass("md-max", 1 === e)
        }

        function w(e) {
          if (!P()) {
            l.addClass("md-active"), l[0].focus(), v();
            var t = R(O(e.pointer.x)), n = C(T(t));
            o.$apply(function () {
              y(n), k(L(n))
            })
          }
        ...
        var F = t.element(l[0].querySelector(".md-thumb")), B = t.element(l[0].querySelector(".md-thumb-text")), z = F.parent(), U = t.element(l[0].querySelector(".md-track-container")), q = t.element(l[0].querySelector(".md-track-fill")), j = t.element(l[0].querySelector(".md-track-ticks")), V = r.throttle(v, 5e3);
        ...
        function k() {
          function e() {
            var e = "left" === _ || "right" === _ ? 2 * Math.sqrt(Math.pow(o.width, 2) + Math.pow(o.height / 2, 2)) : 2 * Math.sqrt(Math.pow(o.width / 2, 2) + Math.pow(o.height, 2)), t = "left" === _ ? {
              left: 100,
              top: 50
            } : "right" === _ ? {left: 0, top: 50} : "top" === _ ? {left: 50, top: 100} : {left: 50, top: 0};
    ...
    function o(e, n, o, r, i) {
      this.$scope = o, this.$element = r, this.$attrs = i, this.size = 0, this.scrollSize = 0, this.scrollOffset = 0, this.horizontal = this.$attrs.hasOwnProperty("mdOrientHorizontal"), this.repeater = null, this.autoShrink = this.$attrs.hasOwnProperty("mdAutoShrink"), this.autoShrinkMin = parseInt(this.$attrs.mdAutoShrinkMin, 10) || 0, this.originalSize = null, this.offsetSize = parseInt(this.$attrs.mdOffsetSize, 10) || 0, this.$attrs.mdTopIndex ? (this.bindTopIndex = n(this.$attrs.mdTopIndex), this.topIndex = this.bindTopIndex(this.$scope), t.isDefined(this.topIndex) || (this.topIndex = 0, this.bindTopIndex.assign(this.$scope, 0)), this.$scope.$watch(this.bindTopIndex, t.bind(this, function (e) {
        e !== this.topIndex && this.scrollToIndex(e)
      }))) : this.topIndex = 0, this.scroller = r[0].getElementsByClassName("md-virtual-repeat-scroller")[0], this.sizer = this.scroller.getElementsByClassName("md-virtual-repeat-sizer")[0], this.offsetter = this.scroller.getElementsByClassName("md-virtual-repeat-offsetter")[0], e(t.bind(this, this.updateSize)), i.ngHide && o.$watch(i.ngHide, t.bind(this, function (n) {
    ...
    var d = 1533917, c = 3;
    o.$inject = ["$$rAF", "$parse", "$scope", "$element", "$attrs"], o.prototype.register = function (e) {
      ...
      if (e !== this.scrollOffset) {
        ...
        if (t) {
          ...
          if (o += n * t + "px)", this.scrollOffset = e, this.offsetter.style.webkitTransform = o, this.offsetter.style.transform = o, this.bindTopIndex) {
            ...
            r !== this.topIndex && r < this.repeater.itemsLength && (this.topIndex = r, this.bindTopIndex.assign(this.$scope, r), this.$scope.$root.$$phase || this.$scope.$digest())
          }
      ...
      if (o !== this.itemsLength && (r = !0, this.itemsLength = o), this.items = e, (e !== n || r) && this.updateIndexes_(), this.parentNode = this.$element[0].parentNode, r && this.container.setScrollSize(o * this.itemSize), this.isFirstRender) {
        ...
        var i = this.$attrs.mdStartIndex ? this.$scope.$eval(this.$attrs.mdStartIndex) : this.container.topIndex;
    ...
    function e(e, o, a, d, c, s, l, m, u, h) {
      function p() {
        a.initOptionalProperties(e, u, {searchText: null, selectedItem: null}), c(o), E(), a.nextTick(function () {
          M(), g(), b(), o.on("focus", b)
        })
      }
      ...
      function f() {
        function t() {
          var e = le.scrollContainer.getBoundingClientRect(), t = {};
          e.right > d.right - i && (t.left = n.right - e.width + "px"), le.$.scrollContainer.css(t)
        }

        if (!le)return a.nextTick(f, !1, e);
        var n = le.wrap.getBoundingClientRect(), o = le.snap.getBoundingClientRect(), d = le.root.getBoundingClientRect(), c = o.bottom - d.top, s = d.bottom - o.top, l = n.left - d.left, m = n.width, u = {
          left: l + "px",
          minWidth: m + "px",
          maxWidth: Math.max(n.right - d.left, d.right - n.left) - i + "px"
        };
        c > s && d.height - n.bottom - i < r ? (u.top = "auto", u.bottom = s + "px", u.maxHeight = Math.min(r, n.top - d.top - i) + "px") : (u.top = c + "px", u.bottom = "auto", u.maxHeight = Math.min(r, d.bottom - n.bottom - i) + "px"), le.$.scrollContainer.css(u), a.nextTick(t, !1)
      }

      function g() {
        le.$.root.length && (c(le.$.scrollContainer), le.$.scrollContainer.detach(), le.$.root.append(le.$.scrollContainer), l.pin && l.pin(le.$.scrollContainer, m))
      }

      function b() {
        e.autofocus && le.input.focus()
      }
      ...
      function M() {
        le = {
          ...
          root: document.body
        }, le.li = le.ul.getElementsByTagName("li"), le.snap = $(), le.$ = y(le)
      }
      ...
      function A(t, n) {
        !t && n ? (f(), le && a.nextTick(function () {
          a.disableScrollAround(le.ul)
      ...
      function w(t, n) {
        t && F(t).then(function (o) {
          e.searchText = o, _(t, n)
        }), t !== n && x()
      }

      function x() {
        t.isFunction(e.itemChange) && e.itemChange(B(e.selectedItem))
      }
      ...
      function D(t, n) {
        de.index = z(), t !== n && F(e.selectedItem).then(function (o) {
          t !== o && (e.selectedItem = null, t !== n && N(), G() ? ie() : (de.matches = [], U(!1), ee()))
        })
      }
      ...
      function O(e) {
        e && (ue = !1), le.input.blur()
      }

      function R() {
        pe = !0, t.isString(e.searchText) || (e.searchText = ""), de.hidden = q(), de.hidden || ie()
      }
      ...
      function L(e) {
        switch (e.keyCode) {
          case d.KEY_CODE.DOWN_ARROW:
            ...
            e.stopPropagation(), e.preventDefault(), de.index = Math.min(de.index + 1, de.matches.length - 1), ne(), ee();
            break;
          case d.KEY_CODE.UP_ARROW:
            if (de.loading)return;
            e.stopPropagation(), e.preventDefault(), de.index = de.index < 0 ? de.matches.length - 1 : Math.max(0, de.index - 1), ne(), ee();
            break;
          case d.KEY_CODE.TAB:
          case d.KEY_CODE.ENTER:
            if (de.hidden || de.loading || de.index < 0 || de.matches.length < 1)return;
            e.stopPropagation(), e.preventDefault(), Q(de.index);
            break;
          case d.KEY_CODE.ESCAPE:
            e.stopPropagation(), e.preventDefault(), Z(), O(!0)
        }
      }
      ...
      function F(t) {
        function n(t) {
          return t && e.itemText ? e.itemText(B(t)) : null
        }
      ...
      function B(e) {
        if (!e)return n;
        var t = {};
        return de.itemName && (t[de.itemName] = e), t
      }
      ...
      function U(e) {
        de.loading != e && (de.loading = e), de.hidden = q()
      }

      function q() {
        return de.loading && !V() || W() || !pe ? !0 : !j()
      }
      ...
      function V() {
        return de.matches.length ? !0 : !1
      }

      function W() {
        return de.scope.selectedItem ? !0 : !1
      }
      ...
      function K() {
        return F(de.matches[de.index])
      }

      function G() {
        return (e.searchText || "").length >= P()
      }
      ...
      function Q(t) {
        a.nextTick(function () {
          F(de.matches[t]).then(function (e) {
            var t = le.$.input.controller("ngModel");
            t.$setViewValue(e), t.$render()
          })["finally"](function () {
            e.selectedItem = de.matches[t], U(!1)
          })
        }, !1)
      }

      function Z() {
        U(!0), de.index = 0, de.matches = [], e.searchText = "", Q(-1);
        var t = document.createEvent("CustomEvent");
        t.initCustomEvent("input", !0, !0, {value: e.searchText}), le.input.dispatchEvent(t), le.input.focus()
      }

      function J(n) {
        function o(t) {
          me[i] = t, (n || "") === (e.searchText || "") && (de.matches = t, de.hidden = q(), e.selectOnMatch && ae(), ee(), f())
        }

        var r = e.$parent.$eval(se), i = n.toLowerCase();
        t.isArray(r) ? o(r) : r && (U(!0), a.nextTick(function () {
      ...
      function te() {
        if (fe === de.matches.length)return "";
        switch (fe = de.matches.length, de.matches.length) {
          case 0:
            return "There are no matches available.";
          case 1:
            return "There is 1 match available.";
          default:
            return "There are " + de.matches.length + " matches available."
        }
      }

      function ne() {
        if (le.li[0]) {
          var e = le.li[0].offsetHeight, t = e * de.index, n = t + e, o = le.scroller.clientHeight, r = le.scroller.scrollTop;
          r > t ? oe(t) : n > r + o && oe(n - o)
        }
      }

      function oe(e) {
        le.$.scrollContainer.controller("mdVirtualRepeatContainer").scrollTo(e)
      }

      function re() {
        var e = (de.scope.searchText || "").length;
        return de.hasNotFound && !V() && !de.loading && e >= P() && pe && !W()
      }

      function ie() {
        var t = e.searchText, n = t.toLowerCase();
        !e.noCache && me[n] ? (de.matches = me[n], ee()) : J(t), de.hidden = q()
      }

      function ae() {
        var t = e.searchText, n = de.matches, o = n[0];
        1 === n.length && F(o).then(function (e) {
          t == e && Q(0)
        })
      }

      var de = this, ce = e.itemsExpr.split(/ in /i), se = ce[1], le = null, me = {}, ue = !1, he = [], pe = !1, fe = 0;
      return X("hidden", A, !0), de.scope = e, de.parent = e.$parent, de.itemName = ce[0], de.matches = [], de.loading = !1, de.hidden = !0, de.index = null, de.messages = [], de.id = a.nextUid(), de.isDisabled = null, de.isRequired = null, de.hasNotFound = !1, de.keydown = L, de.blur = I, de.focus = R, de.clear = Z, de.select = Q, de.listEnter = C, de.listLeave = T, de.mouseUp = k, de.getCurrentDisplayValue = K, de.registerSelectedItemWatcher = H, de.unregisterSelectedItemWatcher = S, de.notFoundVisible = re, de.loadingIsVisible = Y, p()
    }
      ...
      this.nestLevel = parseInt(o.mdNestLevel, 10) || 0, this.init = function (e, t) {
        ...
        o.on("mouseenter", function (n) {
          if (!l.isAlreadyOpening) {
            ...
            var r = n.currentTarget.querySelector("button:not([disabled])");
            r && r.focus()
          }
        ...
        if (l.isOpen) {
          ...
          if (i.$emit("$mdMenuClose", r, a), e.hide(null, o), !n) {
            var d = l.restoreFocusTo || r.find("button")[0];
    ...
    e.$inject = ["$scope", "$element", "$attrs", "$mdConstant", "$document", "$mdUtil", "$timeout"], e.prototype.init = function () {
      ...
      }), r.$on("$mdMenuClose", function (t, r, a) {
        var d = i.getMenus();
        if (-1 != d.indexOf(r[0]) && (e[0].classList.remove("md-open"), r[0].classList.remove("md-open")), a.closeAll && e[0].contains(r[0])) {
          for (var c = r[0]; c && -1 == d.indexOf(c);)c = o.getClosest(c, "MD-MENU", !0);
          c && (a.skipFocus || c.querySelector("button:not([disabled])").focus(), i.currentlyOpenMenu = n, i.disableOpenOnHover(), i.setKeyboardMode(!0))
        }
    ...
    function e() {
      ...
      return {
        require: "^?mdTabs", terminal: !0, compile: function (n, o) {
    ...
    function e(e, o, r, i, a, d, c, s, l, m) {
      function u() {
        ce.selectedIndex = ce.selectedIndex || 0, h(), f(), p(), m(o), d.nextTick(function () {
          oe(), J(), re(), ce.tabs[ce.selectedIndex] && ce.tabs[ce.selectedIndex].scope.select(), he = !0, Y()
        })
      }
      ...
      function v(e) {
        t.element(le.wrapper).toggleClass("md-stretch-tabs", U()), re()
      }
      ...
      function j() {
        if (ce.noPagination || !he)return !1;
        var e = o.prop("clientWidth");
        return t.forEach(le.dummies, function (t) {
          e -= t.offsetWidth
        }), 0 > e
      }
      ...
      function Y() {
        U() || K(), ce.maxTabWidth = G(), ce.shouldPaginate = j()
      }

      function K() {
        var e = 1;
        t.forEach(le.dummies, function (t) {
          e += t.offsetWidth
      ...
      function Z() {
        le.dummies[ce.focusIndex].focus()
      }
      ...
      function oe() {
        ...
        var e = le.contents[ce.selectedIndex], t = e ? e.offsetHeight : 0, r = le.wrapper.offsetHeight, i = t + r, a = o.prop("offsetHeight");
        if ("bottom" === o.attr("md-align-tabs") && (a -= r, i -= r, o.attr("md-border-bottom") !== n && ++a), a !== i) {
          se = !0;
      ...
      var ce = this, se = !1, le = F(), me = [], ue = !1, he = !1;
      g("stretchTabs", v), W("focusIndex", T, ce.selectedIndex || 0), W("offsetLeft", C, 0), W("hasContent", A, !1), W("maxTabWidth", $, G()), W("shouldPaginate", y, !1), b("noInkBar", O), b("dynamicHeight", R), b("noPagination"), b("swipeContent"), b("noDisconnect"), b("autoselect"), b("centerTabs", M, !1), b("enableDisconnect"), ce.scope = e, ce.parent = e.$parent, ce.tabs = [], ce.lastSelectedIndex = null, ce.hasFocus = !1, ce.lastClick = !0, ce.shouldCenterTabs = q(), ce.updatePagination = d.debounce(Y, 100), ce.redirectFocus = Z, ce.attachRipple = de, ce.insertTab = P, ce.removeTab = L, ce.select = _, ce.scroll = H, ce.nextPage = S, ce.previousPage = D, ce.keydown = N, ce.canPageForward = z, ce.canPageBack = B, ce.refreshIndex = ne, ce.incrementIndex = Q, ce.getTabElementIndex = w, ce.updateInkBarStyles = d.debounce(re, 100), ce.updateTabOrder = d.debounce(X, 100), u()
    }
